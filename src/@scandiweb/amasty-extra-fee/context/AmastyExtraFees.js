...
/** @namespace Seedsman/@Scandiweb/AmastyExtraFee/Context/AmastyExtraFees/AmastyExtraFeesProvider */
export const AmastyExtraFeesProvider = ({ children }) => {
    ...
    const { id, items_qty } = useSelector((state) => state.CartReducer.cartTotals);
