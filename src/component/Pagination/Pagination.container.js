...
/** @namespace Seedsman/Component/Pagination/Container/mapStateToProps */
...
/** @namespace Seedsman/Component/Pagination/Container/mapDispatchToProps */
export const mapDispatchToProps = () => ({});

/** @namespace Seedsman/Component/Pagination/Container */
export class PaginationContainer extends PureComponent {
    ...
    componentDidMount() {
        this.updateMetaTagForPagination();
    }
    ...
    updateMetaTagForPagination() {
        const metaTag = document.querySelector('meta[name="robots"]');
        const { location: { search } = {} } = this.props;

        if (metaTag && (search.includes('?page') || search.includes('?p'))) {
