...
/** @namespace Seedsman/Component/WishlistItem/Container/mapStateToProps */
export const mapStateToProps = (state) => ({
    isMobile: state.ConfigReducer.device.isMobile,
    wishlistId: state.WishlistReducer.id
});

/** @namespace Seedsman/Component/WishlistItem/Container/mapDispatchToProps */
...
/** @namespace Seedsman/Component/WishlistItem/Container */
