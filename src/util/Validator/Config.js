...
export const VALIDATION_INPUT_TYPE_TEXT = {
    ...
    alphaDash: 'alphaDash',
    url: 'url',
    specialCharacter: 'specialCharcter'
};
...
export const VALIDATION_MESSAGES = {
    ...
    [VALIDATION_INPUT_TYPE.specialCharacter]: __('Incorrect input! Special character not allowed!'),
    ...
    [VALIDATION_INPUT_TYPE.zipcode]: __('Only 5 characters required!')
    //#endregion
};
...
export const VALIDATION_RULES = {
    ...
    [VALIDATION_INPUT_TYPE.specialCharacter]: /^[A-Za-z0-9 ]+$/,
    ...
    [VALIDATION_INPUT_TYPE.zipcode]: /^[a-zA-Z0-9]{5}$/,
    // eslint-disable-next-line max-len
