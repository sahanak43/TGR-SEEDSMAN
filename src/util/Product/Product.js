...
/**
   ...
   * @returns {boolean}
   * @namespace Seedsman/Util/Product/checkEveryOption  */
...
/** @namespace Seedsman/Util/Product/getIndexedAttributeOption */
...
/** @namespace Seedsman/Util/Product/getIndexedAttributes */
...
/** @namespace Seedsman/Util/Product/getIndexedConfigurableOptions */
...
/** @namespace Seedsman/Util/Product/getIndexedVariants */
...
/** @namespace Seedsman/Util/Product/getIndexedSingleVariant */
export const getIndexedSingleVariant = (variants, itemSku) => {
    const index = variants.findIndex(({ product: { sku } }) => sku === itemSku);
...
/** @namespace Seedsman/Util/Product/getVariantsIndexes */
...
/**
   ...
   * @returns {number}
   * @namespace Seedsman/Util/Product/getVariantIndex  */
...
/** @namespace Seedsman/Util/Product/getIndexedCustomOption */
...
/** @namespace Seedsman/Util/Product/getIndexedCustomOptions */
...
/** @namespace Seedsman/Util/Product/getIndexedReviews */
...
/** @namespace Seedsman/Util/Product/getBundleId */
...
/** @namespace Seedsman/Util/Product/getBundleOptions */
...
/** @namespace Seedsman/Util/Product/getIndexedProduct */
...
/** @namespace Seedsman/Util/Product/getIndexedProducts */
export const getIndexedProducts = (products) => products.map((product) => getIndexedProduct(product));

/** @namespace Seedsman/Util/Product/getIndexedParameteredProducts */
...
/** @namespace Seedsman/Util/Product/sortBySortOrder */
...
/** @namespace Seedsman/Util/Product/getIsConfigurableParameterSelected */
...
/** @namespace Seedsman/Util/Product/getNewParameters */
...
/** @namespace Seedsman/Util/Product/showNewReviewPopup */
export const showNewReviewPopup = () => {
    ...
    if (!isSignedIn() && !isGuestEnabled) {
        dispatch(showNotification('info', 'You must login or register to review products.'));

        return;
    }

    dispatch(showPopup(REVIEW_POPUP_ID, { title: 'Write a review' }));
};

/** @namespace Seedsman/Util/Product/sortAlphabetically */
...
/** @namespace Seedsman/Util/Product/getBooleanLabel */
...
/** @namespace Seedsman/Util/Product/filterConfigurableOptions */
...
/** @namespace Seedsman/Util/Product/validateProductQuantity */
...
/** @namespace Seedsman/Util/Product/getAttributesWithValues */
...
/** @namespace Seedsman/Util/Product/getProductFinalPrice */
export const getProductFinalPrice = (product) => {
    ...
    return formatPrice(+roundPrice(discountValue || value), currency);
};

/** @namespace Seedsman/Util/Product/showOfferSeeds */
export const showOfferSeeds = (product, options) => {
    if (!product.length) {
        return null;
    }

    const [{ attributes }] = product;
    const { attribute_value } = attributes.seeds_number;
    const { attribute_value: offerValue } = attributes.save_x_percent;

    const { label } = options[attribute_value];

    return (
        <div>{ `Save ${ offerValue } by selecting ${ label }` }</div>
    );
};
