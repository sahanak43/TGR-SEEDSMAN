...
/** @namespace Seedsman/Route/ProductPage/Container/mapStateToProps */
...
/** @namespace Seedsman/Route/ProductPage/Container/mapDispatchToProps */
...
/** @namespace Seedsman/Route/ProductPage/Container */
export class ProductPageContainer extends PureComponent {
    ...
    componentDidMount() {
        ...
        // added this for product loading constantly at pdp
    ...
    componentDidUpdate(prevProps) {
        ...
        // if (productSKU !== sku) {
        //     this.requestProduct();
        // } ----commented this for the infinite product load
