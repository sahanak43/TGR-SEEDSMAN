...
/** @namespace Seedsman/Route/SearchPage/Container/mapStateToProps */
...
/** @namespace Seedsman/Route/SearchPage/Container/mapDispatchToProps */
...
/** @namespace Seedsman/Route/SearchPage/Container */
export class SearchPageContainer extends CategoryPageContainer {
    ...
    render() {
        const { hideActiveOverlay, goToPreviousHeaderState, selectedInfoFilter } = this.props;
        return (
            <SearchPage
              ...
              goToPreviousHeaderState={ goToPreviousHeaderState }
              selectedInfoFilter={ selectedInfoFilter }
            />
        );
    }
}
