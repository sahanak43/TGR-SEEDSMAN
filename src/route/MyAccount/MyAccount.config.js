...
export const ACCOUNT_NEWSLETTERS = '/newsletter/manage';
export const ACCOUNT_MYTICKETS = '/ticket/history';
export const ACCOUNT_MYTICKET_URL = '/ticket/view/order_id';
export const ACCOUNT_MYTICKET_NEW = '/ticket/new';
